...
path = 'C:/Users/10/Documents/Kaggle/TalkingData '
...
def get_last_time_click(train,base_feat,roll_time ='1min'):
	result = train_rc[base_feat+['day','click_time']].iloc[::-1].copy()
	# result1 = train_rc[base_feat+['day','click_time']].iloc[::-1].copy()
	result.index=result.click_time

	result.index = pd.datetime(2050,1,1) - result.index
...
data_recent_2min.to_pickle('data/feature_future_2min_data.pkl')
...
data_recent_15min.to_pickle('data/feature_future_15min_data.pkl')
...
data_recent_30min.to_pickle('data/feature_future_30min_data.pkl')
...
data_recent_60min.to_pickle('data/feature_future_60min_data.pkl')
