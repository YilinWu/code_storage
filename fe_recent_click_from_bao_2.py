...
#         result.tohdf(result_path,'w',complib='blosc',complevel=5)
    gc.collect()
    return result
...
data_recent_2min.to_pickle(path+ 'data/feature_recent_2min_data.pkl')
...
data_recent_15min.to_pickle(path+ 'data/feature_recent_15min_data.pkl')
...
data_recent_30min.to_pickle(path+ 'data/feature_recent_30min_data.pkl')
...
data_recent_60min.to_pickle(path+ 'data/feature_recent_60min_data.pkl')
